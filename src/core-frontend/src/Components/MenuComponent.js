...
library.add(faGlobeAmericas, faUserCircle, faSignOutAlt, faSearch, faCogs);
		...
		return (
			...
			<div>
				...
				>
					...
					<a
						className="menu-item"
						href="https://www.jennyly.info/COMP4711/labs/final_project/landingpage.html"
						target="_blank"
					>
						<FontAwesomeIcon
							...
							className="menuIcon"
						/>
						<span>WhereIsYou</span>
					</a>

					<a className="menu-item" href={path + 'Settings.html'}>
						<FontAwesomeIcon icon={faCogs} className="menuIcon" />
						<span>Settings</span>
					</a>
